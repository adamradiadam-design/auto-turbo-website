document.addEventListener('DOMContentLoaded', function () {
  ...
  var CONTACT_EMAIL = 'autoturbo.infos@gmail.com';
  ...
  form.addEventListener('submit', function (e) {
    ...
    /* Pas de serveur derrière ce formulaire : on ouvre le client mail
       du visiteur, pré-rempli avec les informations de sa demande,
       et adressé directement à Auto Turbo. */
    var name = document.getElementById('fName').value.trim();
    var phone = document.getElementById('fPhone').value.trim();
    var email = document.getElementById('fEmail').value.trim();
    var vehicle = document.getElementById('fVehicle').value.trim();
    var message = document.getElementById('fMessage').value.trim();

    var subject = 'Demande de rendez-vous - ' + name;
    var body =
      'Nom complet : ' + name + '\n' +
      'Téléphone : ' + phone + '\n' +
      'E-mail : ' + email + '\n' +
